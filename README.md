...
```bash
    composer req auxmoney/opentracing-bundle-jaeger:^0.3@beta auxmoney/opentracing-bundle-core^0.3@beta opentracing/opentracing:1.0.0-beta6@beta jukylin/jaeger-php:dev-master@dev
```
...
```bash
    composer req auxmoney/opentracing-bundle-zipkin^0.3@beta auxmoney/opentracing-bundle-core^0.3@beta opentracing/opentracing:1.0.0-beta6@beta
```
